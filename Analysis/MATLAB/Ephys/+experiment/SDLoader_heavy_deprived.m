classdef SDLoader_heavy < SDLoader
    ...
    methods
        ...
        function oerc = getRat_AG_Day05_SD(obj)
            path='/run/media/ukaya/mercik/AG/Day05_SD';
            obj.datafolder=path;
        ...
        function eorc = getRat_AA_Day01_SD(obj)
            path='/data2/gdrive/ephys/AA/day01_SD';
            obj.datafolder=path;
            files{1}='/AA-20190530-dat/experiment1/recording1/structure.oebin';
            files{2}='/AA-20190530-dat/experiment2/recording1/structure.oebin';
            eorc=obj.loadOERFiles(fullfile(path,files));
            obj.activeWorkspaceFile=...
                '/data/EphysAnalysis/SleepDeprivationData/RAT_01_AA/Day01_SD';
        end
        function oerc = getRat_AA_Day02_NSD(obj)
            path='/data2/gdrive/ephys/AA/day02_NSD';
            obj.datafolder=path;
            files{1}='/exp-20191105-oe/2019-05-31_23-54-40_TEST/experiment1/recording1/structure.oebin';
            files{2}='/exp-20191105-oe/2019-05-31_23-54-40_TEST/experiment2/recording1/structure.oebin';
            files{3}='/exp-20191105-oe/2019-06-01_08-01-47/experiment1/recording1/structure.oebin';
            files{4}='/exp-20191105-oe/2019-06-01_08-01-47/experiment2/recording1/structure.oebin';
            oerc=obj.loadOERFiles(fullfile(path,files));
            obj.activeWorkspaceFile=...
                '/data/EphysAnalysis/SleepDeprivationData/RAT_01_AA/Day02_NSD';
        end
        function oerc = getRat_AA_Day03_SD(obj)
            path='/data2/gdrive/ephys/AA/day03_SD';
            obj.datafolder=path;
            files{1}='/2019-06-04_07-02-14/experiment1/recording1/structure.oebin';
            files{2}='/2019-06-04_07-02-14/experiment2/recording1/structure.oebin';
            files{3}='/2019-06-04_07-02-14/experiment3/recording1/structure.oebin';
            oerc=obj.loadOERFiles(fullfile(path,files));
            obj.activeWorkspaceFile=...
                '/data/EphysAnalysis/SleepDeprivationData/RAT_01_AA/Day03_SD';
        end
        function oerc = getRat_AA_Day04_NSD(obj)
            path='/data2/gdrive/ephys/AA/day04_NSD';
            obj.datafolder=path;
            files{1}='/2019-06-06_08-07-51/experiment1/recording1/structure.oebin';
            files{2}='/2019-06-06_08-07-51/experiment2/recording1/structure.oebin';
            files{3}='/2019-06-06_08-07-51/experiment3/recording1/structure.oebin';
            oerc=obj.loadOERFiles(fullfile(path,files));
            obj.activeWorkspaceFile=...
                '/data/EphysAnalysis/SleepDeprivationData/RAT_01_AA/Day04_NSD';
        end
