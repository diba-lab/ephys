classdef PositionData < neuro.basic.ChannelTimeData
    ...
    methods
        ...
        function ax = plot3DMark(obj,mark)
            ...
            dims={'X','Z','Y'};
            data1=table2array(obj.data(:,dims))';
            data1(3,:)=data1(3,:)-linspace(1,t_org(end)-t_org(2),size(data1,2));
            data2=data1(:,mark);
        ...
        function [obj]=subsindex(obj,idx)

        end
        function [obj]=subsasgn(obj,idx)

        end
        
        function [obj]=substruct(obj,idx)
