...
int sensorTrig = 0;
int SensorConf=0;
int pumpOpen = 120; // time to keep valve open in ms - recommend 120 to start...
int flag = 0;
...
//    digitalWrite(valve2, LOW);    // turn the LED off by making the voltage LOW 
  ...
  if (digitalRead(sensor1)==LOW && sensorTrig ==0)
{
    digitalWrite(valve2, HIGH);   // turn the LED on (HIGH is the voltage level)
  ...
  if (digitalRead(sensor1)==LOW && flag ==1)
{
    digitalWrite(valve2, HIGH);   // turn the LED on (HIGH is the voltage level)
    digitalWrite(OpenEphys, HIGH);
    delay(pumpOpen);               // wait for a second
...
//========================== sensor 2 =====================================================
  ...
  if (digitalRead(sensor2)==LOW && sensorTrig ==0)
{
    digitalWrite(valve1, HIGH);   // turn the LED on (HIGH is the voltage level)
    digitalWrite(OpenEphys, HIGH);
    delay(pumpOpen);               // wait for a second
  ...
  if (digitalRead(sensor2)==LOW && flag ==2)
{
    digitalWrite(valve1, HIGH);   // turn the LED on (HIGH is the voltage level)
    digitalWrite(OpenEphys, HIGH);
    delay(pumpOpen);               // wait for a second
